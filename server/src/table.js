...
// const sql = ` CREATE TABLE comments (ID INTEGER PRIMARY KEY AUTOINCREMENT, postId INTEGER, name, text, commentImg, date, time);`
// db.run(sql)
// const sql = ` CREATE TABLE posts (ID INTEGER PRIMARY KEY AUTOINCREMENT, name, text, course, category, comments default 0, likes default 0, postImg, date, time);`
// db.run(sql)
