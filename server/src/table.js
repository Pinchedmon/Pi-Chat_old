...
// db.run(sql)
// const sql = ` CREATE TABLE users (ID INTEGER PRIMARY KEY AUTOINCREMENT,name, email, password, roles DEFAULT "USER", pathImg DEFAULT "http://localhost:6060/public/default.jpeg");`
// db.run(sql)
