                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    <div className="flex justify-between items-center border-b-2 border-gray-100 py-4 ">
                        ...
                        <div className=" flex items-center justify-end flex-1">
                            <button className="text-md md:text-xl rounded-md p-2 mr-2 inline-flex items-center justify-center text-green-600 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-green-600 ">
                                Профиль
                            </button>
                        </div>
                        <div>
                            <button onClick={() => setFilterModal(!filterModal)} className="rounded-md p-2 inline-flex items-center justify-center text-green-600 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-green-500">
