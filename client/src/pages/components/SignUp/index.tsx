  ...
  return (
    <>
      ...
      >
        ...
        <h1 className='text-xl mt-4 font-bold text-green-600'>РЕГИСТРАЦИЯ</h1>
        ...
        <button className='w-54 rounded-md font-bold text-green-600 p-1 mt-6 text-lgh-20 text-center border-2 border-green-600'>
          Зарегистрироваться
        </button>

        <Link className='text-sm text-green-600 underline mt-2' to='/login'>
          Уже есть аккаунт?
        </Link>
      </form>
    </>
